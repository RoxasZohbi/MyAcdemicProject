...
namespace E_Project_SevenWonders
{
    ...
    /// </summary>
    public sealed partial class Wonders : Page
    {
        public Wonders()
        {
        ...
        string[] won2 = { "Aurora", "Grand Canyon", "Great Barrier Reef", "Harbor of Rio de Janeiro", "Mount Everest", "Parícutin Volcano", "Victoria Falls", "Great Wall of China", "Petra", "Machu Picchu", "Christ the Redeemer", "Chichen Itza", "Colosseum", "Taj Mahal", "Iguazu Falls", "Hạ Long", "Jeju Island", "Puerto Princesa Underground River", "Table Mountain", "Komodo", "Amazon rainforest", "Durban", "Vigan", "Havana", "Kuala Lumpur", "Beirut", "Doha", "La Paz", "Palau", "Belize Barrier Reef", "Deep-Sea Vents", "Galápagos Islands", "Lake Baikal", "Northern Red Sea" };
        ...
        string[] won = { "Aurora", "Grand Canyon", "Great Barrier Reef", "Harbor of Rio de Janeiro", "Mount Everest", "Parícutin Volcano", "Victoria Falls", "Great Wall of China", "Petra", "Machu Picchu", "Christ the Redeemer", "Chichen Itza", "Colosseum", "Taj Mahal", "Iguazu Falls", "Hạ Long", "Jeju Island", "Puerto Princesa Underground River", "Table Mountain", "Komodo", "Amazon rainforest", "Durban", "Vigan", "Havana", "Kuala Lumpur", "Beirut", "Doha", "La Paz", "Palau", "Belize Barrier Reef", "Deep-Sea Vents", "Galápagos Islands", "Lake Baikal", "Northern Red Sea" };
        private void ListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            string x = lstaccending.SelectedItem.ToString().ToLower();
                foreach (string sample in won)
                {
                    string item = sample.ToLower();
                    if (item.Contains(x))
        ...
        {
            lstaccending.Items.Clear();

            if (Filter.SelectedIndex==0)
            {
                Array.Sort(won2);
             
                foreach (var item in won2)
                {

                    lstaccending.Items.Add(item);
                }
            }
