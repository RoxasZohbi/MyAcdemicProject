...
namespace E_Project_SevenWonders
{
    ...
    /// </summary>
    public sealed partial class NaturalWonder : Page
    {
        DateTime changelast;
        ...
        private void Naturtal_Click(object sender, RoutedEventArgs e)
        {
            if (sender.Equals(AuroraRead))
            {
                Window.Current.Content = new Aurora();
                Window.Current.Activate();
            }
            else if (sender.Equals(GreatRead))
            {
                Window.Current.Content = new GreatBarrierReef();
                Window.Current.Activate();
            }
            else if (sender.Equals(GrandRead))
            {
                Window.Current.Content = new GrandCanyon();
                Window.Current.Activate();
            }
            else if (sender.Equals(HarborRead))
            {
                Window.Current.Content = new Harbor();
                Window.Current.Activate();
            }
            else if (sender.Equals(MountRead))
            {
                Window.Current.Content = new MountEve();
                Window.Current.Activate();
            }
            else if (sender.Equals(VictoriaRead))
            {
                Window.Current.Content = new VictoriaFall();
                Window.Current.Activate();
            }
            else if (sender.Equals(ParicutinRead))
            {
                Window.Current.Content = new Paricutin();
                Window.Current.Activate();
            }
