...
namespace E_Project_SevenWonders
{
    ...
    /// </summary>
    public sealed partial class CitiesWonder : Page
    {
        DateTime changelast;
        public CitiesWonder()
        {
        ...
        {
            if (sender.Equals(DurbanRead))
            {
                Window.Current.Content = new Durban();
                Window.Current.Activate();
            }
            else if (sender.Equals(ViganRead))
            {
                Window.Current.Content = new Vigan();
                Window.Current.Activate();
            }
            else if (sender.Equals(HavanaRead))
            {
                Window.Current.Content = new Havana();
                Window.Current.Activate();
            }
            else if (sender.Equals(KualaLumpurRead))
            {
                Window.Current.Content = new KualaLumpur();
                Window.Current.Activate();
            }
            else if (sender.Equals(BeirutRead))
            {
                Window.Current.Content = new Beirut();
                Window.Current.Activate();
            }
            if (sender.Equals(DohaRead))
            {
                Window.Current.Content = new Doha();
                Window.Current.Activate();
            }
            if (sender.Equals(LaPazRead))
            {
                Window.Current.Content = new LaPaz();
                Window.Current.Activate();
            }
