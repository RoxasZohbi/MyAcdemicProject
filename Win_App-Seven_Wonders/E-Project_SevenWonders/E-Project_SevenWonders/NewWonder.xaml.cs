...
namespace E_Project_SevenWonders
{
    ...
    /// </summary>
    public sealed partial class NewWonder : Page
    {
        DateTime changelast;
        public NewWonder()
        {
        ...
        private void NewWorld_Click(object sender, PointerRoutedEventArgs e)
        {
            if (sender.Equals(HomeBtn))
            {
                Window.Current.Content = new Home();
        ...
        {
            if (sender.Equals(GreatWallRead))
            {
                Window.Current.Content = new WallChina();
                Window.Current.Activate();
            }
            else if (sender.Equals(PetraRead))
            {
                Window.Current.Content = new Petra();
                Window.Current.Activate();
            }
            else if (sender.Equals(RedeemerRead))
            {
                Window.Current.Content = new Redeemer();
                Window.Current.Activate();
            }
            else if (sender.Equals(MachuRead))
            {
                Window.Current.Content = new MachuPicchu();
                Window.Current.Activate();
            }
            else if (sender.Equals(ChichenRead))
            {
                Window.Current.Content = new ChichenItza();
                Window.Current.Activate();
            }
            else if (sender.Equals(ColosseumRead))
            {
                Window.Current.Content = new Colosseum();
                Window.Current.Activate();
            }
            else if (sender.Equals(TajMahalRead))
            {
                Window.Current.Content = new TajMahal();
                Window.Current.Activate();
            }
