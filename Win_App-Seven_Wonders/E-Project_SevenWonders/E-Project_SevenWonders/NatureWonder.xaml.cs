...
namespace E_Project_SevenWonders
{
    ...
    /// </summary>
    public sealed partial class NatureWonder : Page
    {
        DateTime changelast;
        public NatureWonder()
        {
        ...
        {
            if (sender.Equals(IguazuFallsRead))
            {
                Window.Current.Content = new IguazuFalls();
                Window.Current.Activate();
            }
            else if (sender.Equals(HaLongRead))
            {
                Window.Current.Content = new HaLong();
                Window.Current.Activate();
            }
            else if (sender.Equals(JejuIslandRead))
            {
                Window.Current.Content = new JejuIsland();
                Window.Current.Activate();
            }
            else if (sender.Equals(PuertoRead))
            {
                Window.Current.Content = new NationalPark();
                Window.Current.Activate();
            }
            else if (sender.Equals(TableRead))
            {
                Window.Current.Content = new TableMountain();
                Window.Current.Activate();                
            }
            if (sender.Equals(KomodoRead))
            {
                Window.Current.Content = new Komodo();
                Window.Current.Activate();
            }
            if (sender.Equals(AmazonRead))
            {
                Window.Current.Content = new AmazonRainforest();
                Window.Current.Activate();
            }
