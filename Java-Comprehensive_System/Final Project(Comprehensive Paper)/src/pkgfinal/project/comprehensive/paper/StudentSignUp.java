...
public class StudentSignUp extends javax.swing.JFrame {
    ...
    public StudentSignUp(String Name) {
        initComponents();
        naam=Name;
        try {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("SIGN UP FORM FOR STUDENT");
        jPanel1.add(jLabel6);
        ...
        jPanel1.add(enrollmentPre);
        enrollmentPre.setBounds(330, 290, 150, 40);
        jPanel1.add(passwordPre);
        passwordPre.setBounds(330, 350, 150, 40);
        jPanel1.add(FullNamePre);
        FullNamePre.setBounds(330, 230, 160, 40);
        ...
        jPanel1.setBounds(600, 175, 500, 470);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
                Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                Connection c=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ComprehensiveDB;username=sa;password=1.republic");
                String s="INSERT INTO Student VALUES ('"+fullName+"','"+enrollment+"','"+password+"','"+id+"','"+date+"');";
                Statement s1=c.createStatement();
                s1.execute(s);
                JOptionPane.showMessageDialog(null, "Successfully Submit Next Dialoague Box Shows Your Username/ID");
                
                String ss="Select StudentId from Student where StudentName='"+fullName+"'";
                Statement s2=c.createStatement();
                ResultSet rs=s2.executeQuery(ss);
                if(rs.next()){
                int id=rs.getInt("StudentId");
                String Sentence="Here's your Username=S-"+id;
